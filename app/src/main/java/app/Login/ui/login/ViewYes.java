...
public class ViewYes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            String eventChosen = "https://kdy25u7ek3.execute-api.us-east-1.amazonaws.com/dev/rsvp/search?eventid=" + eventId + "&status=2";
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewYes.this, ViewEventActivity.class);
