...
public class EventByLocation extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_event_by_location);
        back = findViewById(R.id.back_to_map);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EventByLocation.this, CampusMap.class);
        ...
        try {
            String locationEvents = "https://kdy25u7ek3.execute-api.us-east-1.amazonaws.com/dev/event/search?location=" + location;
            Log.d("View Event", locationEvents);
            eventSearch = new URL(locationEvents);
